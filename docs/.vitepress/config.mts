    ...
    nav: [
      ...
      { text: 'Roadmap', link: '/roadmap/' },
      {
        ...
        items: [
          ...
          { text: 'Dev Homelab', link: 'https://nasraldin.github.io/dev-homelab/' },
        ],
      },
    ],
      ...
      '/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Guest VMID map', link: '/operations/guest-vmid-map' },
            { text: 'database-01 (central DB)', link: '/operations/database-01' },
            { text: 'Docker / Podman hosts', link: '/operations/docker-hosts' },
            { text: 'Ollama (llm-01)', link: '/operations/ollama-llm-01' },
            { text: 'OpenClaw', link: '/operations/openclaw' },
            { text: 'Stalwart / webmail', link: '/operations/stalwart' },
            { text: 'Keycloak', link: '/operations/keycloak' },
            { text: 'SonarQube', link: '/operations/sonarqube' },
            { text: 'Elastic / Kibana', link: '/operations/elastic' },
            { text: 'Monitoring', link: '/operations/monitoring' },
            { text: 'Dockhand', link: '/operations/dockhand' },
            { text: 'GitLab runner (k8s)', link: '/operations/gitlab-runner-k8s' },
            { text: 'Core hosts acceptance', link: '/operations/core-hosts-acceptance' },
            { text: 'GitLab TF/Ansible CI', link: '/operations/gitlab-infra-pipeline' },
            { text: 'Runner autoscaling', link: '/operations/gitlab-runner-autoscaling' },
            { text: 'Repo audit checklist', link: '/operations/repo-audit-checklist' },
            { text: 'Infra01 remote access (off-LAN)', link: '/operations/infra01-remote-access' },
