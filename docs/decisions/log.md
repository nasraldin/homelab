...
| 2026-07-30 | Ollama primary = `llm-01` LXC (host amdgpu)                    | **Superseded 2026-09-12** — CT 126 destroyed; was CT `.26` with ROCm/GPU — [ollama-llm-01.md](../operations/ollama-llm-01.md)                     |
| 2026-09-12 | Remove `ssh-01` + `llm-01`; drop Proxmox VM tags               | Jumpbox and local Ollama unused; SSH to guests directly; tags added no value                                                                      |
