...
| Router IPv6 DNS polish                       | ✅ Mac pin (Deco has no RDNSS) |
| OPNsense VLAN Pilot                          | ⏸️ archived                    |
| Vault (`vault-01`) + AIStor (`aistor-01`)    | ✅ core Layer-1                |
| NetBird                                      | ⏳ optional                    |
| kubeadm + Argo CD                            | ⏳ Phase 6–7                   |

Next: [current-state.md](../current-state.md) · optional Terraform CI, then
kubeadm when ready
