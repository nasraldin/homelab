...
| **ssh-01**                                | —                                                                  | ❌ gone  | Jumpbox CT **112** **destroyed 2026-09-12** — SSH directly to guests                                                                                |
...
| **Ollama**                                | —                                                                  | ❌ gone  | CT **126** `llm-01` **destroyed 2026-09-12** — no local inference host; [ollama-llm-01.md](../operations/ollama-llm-01.md) is historical            |
| **LiteLLM**                               | ☸ `ai-tools`                                                       | 10       | OpenAI gateway — **no local Ollama backend** until a replacement is added                                                                           |
