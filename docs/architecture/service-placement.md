...
| **ssh-01**                                | 📦 Jumpbox LXC **112** (`.12`)               | ✅ live  | SSH/operator only — renamed from `infra-01`; no DNS/NPM/Infisical/AIStor                                                                                                 |
...
| **Ollama**                                | 📦 **LXC** `llm-01` CT **126** (`.26`)   | 10       | **Live** host `amdgpu` + `/dev/dri`/`kfd`; UIs via **LiteLLM** — [ollama-llm-01.md](../operations/ollama-llm-01.md); **ai-01 destroyed** |
| **LiteLLM**                               | ☸ `ai-tools`                            | 10       | OpenAI gateway → Ollama on `.26` only                                                                                                                                     |
| **LibreChat** / OpenClaw                  | ☸ `ai-tools`                            | 10       | Through LiteLLM — not Ollama direct; OpenClaw UI http://openclaw.lab                                                                                                      |
| **n8n**                                   | ☸ `ai-tools`                            | 10       | **Workflow only** — LLM via LiteLLM OpenAI creds; [itsm-and-automation.md](../platform/itsm-and-automation.md)                                                           |
