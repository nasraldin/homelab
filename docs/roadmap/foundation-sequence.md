...
| 16b | Infisical (`infisical-01` LXC `.25` for lab-home-k8s) | ⏳/✅ | App env-secrets; cutover from infra/docker per [lab-restructure](../operations/lab-restructure-2026-07-30.md) · [infisical.md](../operations/infisical.md) |
