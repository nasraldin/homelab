...
- **OpsHub** — sibling [`opshub`](https://github.com/nasraldin/opshub) repo (clone as `opshub/` via [`clone-labs.sh`](https://github.com/nasraldin/homelab/blob/main/clone-labs.sh)); design spec: [OpsHub](/superpowers/specs/2026-07-22-homelab-dashboard-design)
